...
import commands.distros.action.edit_distros_list
import commands.distros.distros_handler as dh
import commands.distros.utils.distro_list_enums
...
class TestDistroHandler(unittest.TestCase):
    ...
    def test_validate_distros_normal(self):
        validation = commands.distros.action.edit_distros_list.validate_distros(self.curr_distros)
    ...
    def test_combine_distros_add_noduplicate(self):
        action = commands.distros.utils.distro_list_enums.Action.ADD

        actual_distros = commands.distros.action.edit_distros_list.combine_distros(self.curr_distros, self.new_distros, action)
    ...
    def test_combine_distros_update_noduplicate(self):
        action = commands.distros.utils.distro_list_enums.Action.UPDATE
        actual_distros = commands.distros.action.edit_distros_list.combine_distros(self.curr_distros, self.new_distros, action)
        self.assertDictEqual(actual_distros, self.expected_distros)
    ...
    def test_combine_distros_delete_noduplicate(self):
        action = commands.distros.utils.distro_list_enums.Action.DELETE
