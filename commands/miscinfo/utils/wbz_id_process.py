...
class WBZInfo:
    def __init__(self, wbz_id, image_id, page_id, track_name, track_version, version_extra,  image_hash, unique_editors):
        self.wbz_id = wbz_id
        ...
        self.unique_editors = unique_editors
...
def get_wbz_info(wbz_id):
    ...
    track_updaters = set(track_info["track_editor"].split(","))
    unique_updaters = track_updaters - track_authors
    ...
    return WBZInfo(orig_wbz_id, wbz_id, page_id, track_name, track_version, track_version_extra, image_hash, unique_updaters)